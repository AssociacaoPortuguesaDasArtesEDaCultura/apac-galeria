  ...
  return (
    <Box component="div">
      ...
      >
        ...
        {/* FULL WIDTH */}
        <Grid container sx={{ display: { xs: "none", sm: "flex" }, my: 10 }}>
          <Grid xs={2}>
            <Avatar
              src={checkLink(artist.profilePicture)}
        ...
        {/* MOBILE */}
        <Grid container sx={{ display: { xs: "flex", sm: "none" }, my: 1 }}>
          <Grid xs={12}>
            <Avatar
              sx={{
                width: "8rem",
        ...
        <Grid
          ...
          sx={{
            justifyContent: {
              xs: "center",
              sm:
                products && products.length === 0 ? "center" : "space-between",
            },
            my: "1rem",
          }}
