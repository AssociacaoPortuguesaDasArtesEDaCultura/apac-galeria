          ...
          >
            ...
            <Autocomplete
              ...
              onChange={(
                ...
                newValue !== null ? setMaterials(newValue) : setMaterials([])
              }
            ...
            <Grid container marginTop={2} spacing={4}>
              {imageUrls.length === 0 && (
                <Grid xs={6} sm={4} md={3}>
                  ...
                  >
                    <Tooltip title={t("artist.new-piece-page.add-thumbnail")}>
                      <IconButton
                        sx={{ border: 2 }}
                    ...
                    <Typography textAlign={"center"}>
                      {t("artist.new-piece-page.add-thumbnail")}
                    </Typography>
                  </Box>
                </Grid>
              )}
              ...
              {imageUrls.length < MAX_IMAGES && imageUrls.length > 0 && (
                <Grid xs={6} sm={4} md={3}>
                  <Box
                    component={"div"}
                    display={"flex"}
                  ...
                  >
                    <Tooltip title={t("artist.new-piece-page.add-photos")}>
                      <IconButton
                        sx={{ border: 2 }}
                        onClick={addNewImageButtonClick}
                      >
                    ...
                    <Typography textAlign={"center"}>
                      {t("artist.new-piece-page.choose-photos")}
                    </Typography>
                  </Box>
                </Grid>
              )}
