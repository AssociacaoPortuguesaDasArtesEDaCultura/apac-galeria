...
export default function NewSeller() {
  ...
  return (
    <>
            ...
            <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
              ...
              <Box component="div">
                <TextField
                  ...
                  fullWidth
                  error={showNameAlert}
                  helperText={showNameAlert ? t("errors.profile.name") : " "}
                ...
                <TextField
                  ...
                  helperText={showEmailAlert ? t("errors.profile.email") : " "}
                  label={t("forms.email")}
                  type="email"
                  id="email"
                  autoComplete="email"
      ...
      <Slide direction="up" in={saveErrorAlert} mountOnEnter unmountOnExit>
        <Box
          className="fixed bottom-10"
          component={"div"}
          width={"100vw"}
