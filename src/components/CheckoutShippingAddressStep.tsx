...
const CheckoutStep2 = ({ setValidFunc }: CheckoutStep2Props) => {
  ...
  const [showCountryAlert] = useState(false);
        ...
        <form style={{ width: "100%" }} onSubmit={handleSubmit}>
          ...
          >
            ...
            <TextField
              ...
              error={showCityError}
              helperText={
                showCityError ? t("checkout.shipping.city-error") : " "
              }
              autoComplete="city"
              value={city}
          ...
          <Stack
            ...
            sx={{ marginBottom: 1, marginTop: 2 }}
          >
            <Typography variant="h6" color="black" className="font-poppins">
              {t("checkout.shipping.shipping-cost")}
            </Typography>
            <Typography variant="body1" color="black" className="font-poppins">
