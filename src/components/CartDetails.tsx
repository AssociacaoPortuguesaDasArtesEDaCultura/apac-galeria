...
const CartDetails = () => {
  ...
  const { dispatch, totalItems, subTotalPrice, REDUCER_ACTIONS } = useCart();
  const navigate = useNavigate();

  const [shippingCost] = useState(0);
  const [subtotal] = useState(parseFloat(subTotalPrice));
  const [tax] = useState(0.23);
  ...
  return (
    <Box component="div">
      ...
      >
        ...
        <Grid xs={12} sm={12} md={4} className="dark:bg-gray-800 rounded-md ">
