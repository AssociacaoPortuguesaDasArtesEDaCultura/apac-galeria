      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography>
              {dayjs(props.product.published_date).format("DD/MM/YYYY")}
            </Typography>
          </Stack>
          <Stack
            justifyContent={"space-between"}
          ...
          >
            <Stack direction={"row"} alignItems={"center"} spacing={1}>
              <Typography>
                {
                  (props.product._seller as User).seller_fields?.demographics
                    .name
                }
              </Typography>
              <Avatar
                src={
                  (props.product._seller as User).seller_fields?.profile_picture
                }
                alt={
                  (props.product._seller as User).seller_fields?.demographics
                    .name
